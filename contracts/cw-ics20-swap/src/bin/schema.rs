...
use cw_ics20_swap::msg::{
    ...
    LockupExecuteMsg, LockupInitMsg, LockupResponse, QueryMsg, TransferMsg,
};
...
fn main() {
    ...
    export_schema(&schema_for!(LockupInitMsg), &out_dir);
    export_schema(&schema_for!(LockupExecuteMsg), &out_dir);
    export_schema(&schema_for!(ChannelResponse), &out_dir);
    export_schema(&schema_for!(ListChannelsResponse), &out_dir);
    export_schema(&schema_for!(ConfigResponse), &out_dir);
    export_schema(&schema_for!(LockupResponse), &out_dir);
    export_schema(&schema_for!(ListLockupResponse), &out_dir);
